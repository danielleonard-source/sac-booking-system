...
function VenueFormModal() {
  const { venueFormOpen, editingItem, closeVenueForm, showNotification } = useUIStore();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingItem) {
        await updateVenue(editingItem.id, venueData);
      ...
      <div className="bg-white rounded-lg shadow-2xl max-w-lg w-full">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-purple-700 px-6 py-4 flex justify-between items-center">
          <h2 className="text-2xl font-bold text-white">
            {editingItem ? '✏️ Edit Venue' : '➕ Add New Venue'}
          </h2>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., Exam Room A, T136, Q110"
              required
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              min="1"
            />
            <p className="text-xs text-gray-500 mt-1">Maximum number of learners</p>
          </div>
          ...
          <div className="flex justify-end space-x-3 pt-4 border-t">
            ...
            >
              {editingItem ? 'Update Venue' : 'Add Venue'}
            </button>
          </div>
        </form>
      </div>
